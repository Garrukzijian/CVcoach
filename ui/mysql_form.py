...
"padding-bottom:2px;")
        self.admin_login_of_user_name_lineEdit.setReadOnly(False)
...
"padding-bottom:2px;")
    ...
    def retranslateUi(self, Frame):
        ...
        Frame.setWindowTitle(_translate("Frame", "Database"))
        self.groupBox_4.setTitle(_translate("Frame", "Admin login"))
        self.admin_login_of_user_name_lineEdit.setPlaceholderText(_translate("Frame", "Admin username"))
        self.admin_login_of_password_lineEdit.setPlaceholderText(_translate("Frame", "Admin password"))
        self.admin_login_pushButton.setText(_translate("Frame", "Login"))
        self.label.setText(_translate("Frame", "Database"))
        self.fresh_pushButton.setText(_translate("Frame", "User table"))
        self.groupBox_2.setTitle(_translate("Frame", "Add user"))
        self.add_user_of_user_name_lineEdit.setPlaceholderText(_translate("Frame", "Username"))
        self.add_user_of_password_lineEdit.setPlaceholderText(_translate("Frame", "password"))
        self.add_user_pushButton.setText(_translate("Frame", "Add user"))
        self.groupBox.setTitle(_translate("Frame", "Delete user"))
        self.delete_user_of_id_lineEdit.setPlaceholderText(_translate("Frame", "User ID"))
        self.delete_user_pushButton.setText(_translate("Frame", "Delete user"))
        self.groupBox_3.setTitle(_translate("Frame", "Modify User"))
        self.change_user_of_id_lineEdit.setPlaceholderText(_translate("Frame", "ID"))
        self.change_user_pushButton.setText(_translate("Frame", "Modify"))
        self.change_user_of_user_name_lineEdit.setPlaceholderText(_translate("Frame", "Username"))
        self.change_user_of_phone_lineEdit.setPlaceholderText(_translate("Frame", "Phonenumber"))
        self.change_user_of_email_lineEdit.setPlaceholderText(_translate("Frame", "Email"))
        self.change_user_of_password_lineEdit.setPlaceholderText(_translate("Frame", "Password"))

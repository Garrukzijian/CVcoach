...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.title_label.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:11pt; color:#ffaa7f;\">Close Application</span></p></body></html>"))
        self.is_min_status_checkBox.setText(_translate("Dialog", "Minimize to taskbar icon"))

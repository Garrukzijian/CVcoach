...
class login_form(ui_form, QFrame):
    ...
    def login_pushButton_event(self):
        ...
        if user_name == "" or password == "":
            QMessageBox.information(self, "Wrong", "Please enter username and password")
            return
        ...
        if info is not None:
            ...
            QMessageBox.information(self, "Wrong", "username or password wrong，please try again")

    def forget_password_pushButton_event(self):
        logger.info("Forget password")
        QMessageBox.information(self, "Forget password", "Please connect admin")
    ...
    def github_pushButton_event(self):
        logger.info("Jump to github site")
